...
The maintainer of the project is [Rakesh Bal](https://github.com/rakeshbal99).
...
If you found an error, mistype or any other flawback in the project, please report about it using [issues](https://github.com/rakeshbal99/Solution-List/issues).
